...
@section('konten')
    <div class="container-xxl flex-grow-1 container-p-y">
        <div class="row">
            <div class="col-md-6">
                <div class="card mb-4">
                    <h5 class="card-header">Tambah Stok keluar</h5>
                    <div class="card-body">
                        ...
                        <form action="{{ route('stokout.store') }}" method="POST" enctype="multipart/form-data"
                            ...
                            <div class="row mt-5">
                                <div class="col-sm-12">
                                    <a href="{{ route('stokout.index') }}" class="btn btn-link btn-sm">Kembali</a>
...
@section('script')
    ...
    {!! JsValidator::formRequest('App\Http\Requests\Stok\StokOutRequest', '#my-form') !!}
